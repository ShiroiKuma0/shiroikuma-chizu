...
public class VoiceRouter {
	...
	public void announceAlarm(AlarmInfo info, float speed) {
		...
		if (type == AlarmInfoType.SPEED_LIMIT) {
			...
			boolean speakSpeedCamera = type.isSpeedCameraType() && settings.SPEAK_SPEED_CAMERA.get();
			boolean speakPrefType = type == AlarmInfoType.TUNNEL || type == AlarmInfoType.PEDESTRIAN || type.isSpeedCameraType();
