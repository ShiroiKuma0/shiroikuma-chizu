...
public class AppVersionUpgradeOnInit {
	...
	// 5401 - 5.4-01 (Migrate transparent widgets to per-panel background mode)
			...
			for (ScreenLayoutMode layoutMode : layoutModes) {
				...
				if (transparentPreference.isSetForMode(appMode) && transparentPreference.getModeValue(appMode)) {
					for (WidgetsPanel panel : WidgetsPanel.values()) {
						PanelAppearanceSettings appearanceSettings = PanelAppearanceSettings.getInstance(app, panel);
